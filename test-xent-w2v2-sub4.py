...
def setup(hparams, run_opts):
    ...
    print("Subtracting prior" if getattr(hparams, "subtract_prior", True) else "Not subtracting prior")
    modules.eval()
